...
func TestTravelTime(t *testing.T) {
	cases := []struct {
		...
		{name: "public transport 1", want: 624, transportMode: "public_transport", distance: 1, wantErr: false},
		{name: "public transport 2", want: 768, transportMode: "public_transport", distance: 2, wantErr: false},
